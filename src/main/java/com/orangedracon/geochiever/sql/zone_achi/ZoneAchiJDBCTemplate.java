...
public class ZoneAchiJDBCTemplate implements ZoneAchiDAO {
	...
	// ZoneAchi zoneAchi = jdbcTemplate.queryForObject(sqlComm, new Object[]{id},
	// new ZoneAchiMapper());
	//
	// return zoneAchi;
	// }
	...
	// List<ZoneAchi> allZoneAchiList = jdbcTemplate.query(sqlComm, new Object[]{},
	// new ZoneAchiMapper());
	//
	// return allZoneAchiList;
	// }
	//
	// public List<ZoneAchi> getAchievedUserZoneAchi_byUsername(String username, int
	// isActive){
	// String sqlComm = "SELECT * FROM zone_achievement pa, user_achievement_zone
	// uap, user u "
	// + "WHERE u.id_user = uap.user_id AND uap.achievement_id = pa.id AND
	// u.username = ? AND pa.active = ?";
	// List<ZoneAchi> userAchievedZoneAchiList = jdbcTemplate.query(sqlComm, new
	// Object[]{username, isActive}, new ZoneAchiMapper());
	//
	// return userAchievedZoneAchiList;
	// }
	//
	// public List<ZoneAchi> getUndoneUserZoneAchi_byUsername(String username, int
	// isActive){
	...
	// + "WHERE u.id_user = uap.user_id AND uap.achievement_id = pa.id AND
	// u.username = ? AND pa.active = ?)";
	// List<ZoneAchi> userUndoneZoneAchiList = jdbcTemplate.query(sqlComm, new
	// Object[]{username, isActive}, new ZoneAchiMapper());
	//
	...
	// List<ZoneAchi> latestZoneAchiList = jdbcTemplate.query(sqlComm, new
	// Object[]{username}, new ZoneAchiMapper());
	//
