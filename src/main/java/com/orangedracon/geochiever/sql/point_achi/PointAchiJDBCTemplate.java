...
public class PointAchiJDBCTemplate implements PointAchiDAO {
	...
	// List<PointAchi> allPointAchiList = jdbcTemplate.query(sqlComm, new
	// Object[]{}, new PointAchiMapper());
	//
	...
	// new Object[]{username, isActive}, new PointAchiMapper());
	//
	...
	// Object[]{username, isActive}, new PointAchiMapper());
	//
	...
	// Object[]{username}, new PointAchiMapper());
	//
